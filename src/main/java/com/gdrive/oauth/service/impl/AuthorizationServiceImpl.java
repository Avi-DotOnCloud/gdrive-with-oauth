...
public class AuthorizationServiceImpl implements AuthorizationService {
	...
	public void init() throws Exception {
		...
		InputStreamReader reader = new InputStreamReader(new ClassPathResource("keys/credentials.json").getInputStream());

		//dataStoreFactory = new FileDataStoreFactory(config.getCredentialsFolder().getFile());
		dataStoreFactory = new FileDataStoreFactory(new ClassPathResource("credentials").getFile());
